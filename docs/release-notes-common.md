...
- Ablegelisten: Werden nacheinander mehrere Aufgaben geladen, werden die Ablegelisten der verlassenen Aufgaben wieder freigegeben. Bisher behielt das Modul sie alle, samt dem Formular ihrer Aufgabe: der Speicherbedarf wuchs mit jeder Aufgabe, und das Aufnehmen eines Ziehelements dauerte zunehmend länger, weil dabei jedes Mal alle je gesehenen Listen durchgerechnet wurden ([#1384](https://github.com/iqb-berlin/verona-modules-aspect/issues/1384))
