...
- Tabelle: Ein Eingabebereich in einer Tabellenzelle zeigt seine Hintergrundfarbe. Bisher blieb er weiß, während dieselbe Einstellung außerhalb einer Tabelle und beim Eingabefeld auch in der Zelle wirkte. Ohne eigene Einstellung ist er jetzt durchsichtig wie das Eingabefeld — in einer farbigen Zelle also nicht mehr weiß ([#1361](https://github.com/iqb-berlin/verona-modules-aspect/issues/1361))
