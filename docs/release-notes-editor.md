...
- Schieberegler: Die beiden Anzeigeoptionen "Balken-Darstellung" und "Werteanzeige am Griff" sind bei neuen Elementen wieder ausgeschaltet. Seit April 2026 waren sie in den 3.0.0-Betas versehentlich an — nicht durch eine Entscheidung, sondern weil bei der Umstellung auf den neuen Migrationsmechanismus statt der Schalter (aus/an) zwei Textwerte eingetragen wurden, die immer als "an" gelesen wurden. Betroffen waren neu angelegte Schieberegler und solche in Aufgaben, die mit einer Beta geöffnet und gespeichert wurden. Beim Laden werden diese Textwerte jetzt korrigiert; bewusst gesetzte Häkchen bleiben erhalten. In der produktiven Version 2.12.5 gab es das Problem nicht
