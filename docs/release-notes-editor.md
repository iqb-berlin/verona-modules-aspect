...
- Mehrfachauswahl: abweichende Werte sind jetzt erkennbar
  ...
  - Auch Felder, in denen ein leerer Wert selbst eine gültige Angabe ist, unterscheiden jetzt zwischen "bei allen leer" und "unterschiedlich": Mindest- und Maximalbreite, Mindest- und Maximalhöhe, "Elemente je Zeile begrenzen" und die Vorbelegung des Schiebereglers. Sind die Werte unterschiedlich, zeigt das zugehörige Kontrollkästchen seinen Zwischenzustand, das Feld bleibt bedienbar und trägt den Hinweis "Werte unterschiedlich". Bisher sah eine Auswahl mit unterschiedlichen Grenzen aus wie eine ohne jede Grenze, das Feld war dabei gesperrt — eine gemeinsame Grenze ließ sich also erst eingeben, nachdem man das Kästchen aus- und wieder eingeschaltet und damit alle vorhandenen Grenzen gelöscht hatte
