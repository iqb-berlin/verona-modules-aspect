...
- Fehlerdialog "Unerwarteter Fehler": Trat ein Fehler auf, der beim Aufbau der Arbeitsfläche immer wieder auftritt, öffnete sich der Dialog endlos neu — auch "Verwerfen" brachte ihn sofort zurück, und der Editor war nicht mehr bedienbar, sodass die Aufgabe nicht einmal mehr gespeichert werden konnte. Ursache war der Dialog selbst: sein Öffnen und Schließen lässt die Arbeitsfläche neu zeichnen, was denselben Fehler wieder auslöste. Derselbe Fehler wird jetzt einmal je Sitzung gemeldet, danach bleibt der Editor bedienbar; ein anderer Fehler wird weiterhin gemeldet
