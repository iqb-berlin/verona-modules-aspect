...
### Fehlerbehebungen
- Bilder verkleinern: Das verkleinerte Bild ist feiner. Bisher las der Browser dafür nur vier Quellpixel je Zielpixel — bei einer Verkleinerung auf ein Drittel trug damit rund jeder zehnte Bildpunkt zum Ergebnis bei, der Rest fiel weg. Dünne Linien und kleine Schrift verloren dadurch mehr als nötig, und das Ergebnis wirkte im Vergleich zu einem Bildbearbeitungsprogramm ausgefranst. Außerdem werden die Zielmaße jetzt gerundet: Ergab die Rechnung eine gebrochene Höhe, wurde das Bild um einen halben Bildpunkt versetzt gezeichnet und die unterste Zeile abgeschnitten. Bei verlustbehafteten Formaten wird die Datei dabei nebenbei kleiner, weil das Ausfransen selbst Bytes gekostet hat. In einem Browser, der das feinere Rechnen nicht beherrscht — derzeit Safari —, sagt der Dialog das jetzt ([#1434](https://github.com/iqb-berlin/verona-modules-aspect/issues/1434))
