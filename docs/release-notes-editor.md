...
## 3.0.1
### Neue Funktionen
- Neues Element "Tetfolio": Ein tet.folio-Export (ZIP) lässt sich im Eigenschaftenbereich hochladen; der Editor packt ihn in ein eigenständiges HTML-Dokument und zeigt das Experiment in der Aufgabe an
...
- Der Qualitätsregler im Verkleinern-Dialog wirkt jetzt auch dann, wenn die Maße unverändert bleiben. Bisher gab der Dialog ein Bild unverändert zurück, sobald weder Breite noch Format geändert wurden — der Regler entschied dann nichts. Ein Bild, das nur zu groß in Bytes, aber richtig in den Maßen ist, lässt sich damit erstmals verkleinern. Ein Upload, den man nur bestätigt, ohne den Regler anzufassen, wird weiterhin unverändert übernommen ([#1398](https://github.com/iqb-berlin/verona-modules-aspect/issues/1398))
- Bildbereiche: Werden beim Verkleinern die Maße geändert, warnt der Dialog — die Bildbereiche liegen an festen Positionen im Bild und wandern nicht mit. Nur die Dateigröße zu senken, ohne die Maße anzufassen, lässt sie unberührt ([#1399](https://github.com/iqb-berlin/verona-modules-aspect/issues/1399))
