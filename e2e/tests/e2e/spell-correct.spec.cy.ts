...
describe('Spell correct element', { testIsolation: false }, () => {
  context('editor', () => {
    ...
    it('creates a mandatory spell correct element', () => {
      addElement('Wort korrigieren');
  ...
  context('player', () => {
    ...
    it('creates the readonly spell correct element', () => {
