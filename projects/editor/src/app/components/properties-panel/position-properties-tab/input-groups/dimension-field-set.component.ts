  ...
  template: `
    <fieldset>
      ...
      <ng-container *ngIf="unitService.unit.pages[selectionService.selectedPageIndex]
        ...
        <ng-container *ngIf="dimensions.minWidth !== undefined">
        ...
        <ng-container *ngIf="dimensions.maxWidth !== undefined">
        ...
        <ng-container *ngIf="dimensions.minHeight !== undefined">
        ...
        <ng-container *ngIf="dimensions.maxHeight !== undefined">
