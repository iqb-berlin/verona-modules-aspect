...
compile error, and reading a default the table does not define is one too. Historical context: as an
untyped `Record<string, unknown>`, a string default for a `boolean` property travelled into stored
units unnoticed for months (#1139).
